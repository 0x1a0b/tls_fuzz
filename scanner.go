...
func GetCiphers() (ciphers []Cipher) {
	...
	ciphers = []Cipher{
		...
		Cipher{Name: "TLS_AES_256_GCM_SHA384",
			Tlscode:        tls.TLS_AES_256_GCM_SHA384,
			Rfc:            "8446",
		...
		Cipher{Name: "TLS_AES_128_GCM_SHA256",
			Tlscode:        tls.TLS_AES_128_GCM_SHA256,
			Rfc:            "8446",
		...
		Cipher{Name: "TLS_CHACHA20_POLY1305_SHA256",
			Tlscode:        tls.TLS_CHACHA20_POLY1305_SHA256,
			Rfc:            "8446",
		...
		// others
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256,
			Rfc:            "7905",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256,
			Rfc:            "7905",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,
			Rfc:            "5289",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_RSA_WITH_RC4_128_SHA",
			Tlscode:        tls.TLS_ECDHE_RSA_WITH_RC4_128_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,
			Rfc:            "8422",
		...
		Cipher{Name: "TLS_ECDHE_ECDSA_WITH_RC4_128_SHA",
			Tlscode:        tls.TLS_ECDHE_ECDSA_WITH_RC4_128_SHA,
			Rfc:            "8422",
			Csinfolink:     "https://ciphersuite.info/cs/TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA/",
			Csinfoapi:      "https://ciphersuite.info/api/cs/TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA/",
			Tlsminversion:  "TLS1.0",
		...
		Cipher{Name: "TLS_RSA_WITH_AES_256_GCM_SHA384",
			Tlscode:        tls.TLS_RSA_WITH_AES_256_GCM_SHA384,
			Rfc:            "5288",
		...
		Cipher{Name: "TLS_RSA_WITH_AES_128_GCM_SHA256",
			Tlscode:        tls.TLS_RSA_WITH_AES_128_GCM_SHA256,
			Rfc:            "5288",
		...
		Cipher{Name: "TLS_RSA_WITH_AES_128_CBC_SHA256",
			Tlscode:        tls.TLS_RSA_WITH_AES_128_CBC_SHA256,
			Rfc:            "5246",
		...
		Cipher{Name: "TLS_RSA_WITH_AES_256_CBC_SHA",
			Tlscode:        tls.TLS_RSA_WITH_AES_256_CBC_SHA,
			Rfc:            "5246",
		...
		Cipher{Name: "TLS_RSA_WITH_AES_128_CBC_SHA",
			Tlscode:        tls.TLS_RSA_WITH_AES_128_CBC_SHA,
			Rfc:            "5246",
		...
		Cipher{Name: "TLS_RSA_WITH_3DES_EDE_CBC_SHA",
			Tlscode:        tls.TLS_RSA_WITH_3DES_EDE_CBC_SHA,
			Rfc:            "5246",
		...
		Cipher{Name: "TLS_RSA_WITH_RC4_128_SHA",
			Tlscode:        tls.TLS_RSA_WITH_RC4_128_SHA,
			Rfc:            "5246",
...
func fuzzTlsHost(s Scanner) {
	...
	for _, cipher := range allCiphers {
		log.Debugf("about to try with %v should be %v", cipher.Tlscode, cipher.Name)
		conf := getConfigForCipher(cipher.Tlscode, s.TlsSNI)
